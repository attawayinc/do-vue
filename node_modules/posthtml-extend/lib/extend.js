...
exports.default = function () {
    ...
    return function (tree) {
        ...
        var blockNodes = getBlockNodes(tree, options.slotTagName);
...
function handleExtendsNodes(tree, options, messages) {
    _api.match.call(applyPluginsToTree(tree, options.plugins), { tag: options.tagName }, function (extendsNode) {
...
function mergeExtendsAndLayout(layoutTree, extendsNode, strictNames, slotTagName, fillTagName) {
    var layoutBlockNodes = getBlockNodes(layoutTree, slotTagName);
    var extendsBlockNodes = getBlockNodes(extendsNode.content, fillTagName);
...
function getBlockNodes() {
    ...
    _api.match.call(content, { tag: tag }, function (node) {
